  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
        ...
        ">Project <span className="text-white">Creation / Revision</span> consume <span className="text-white">credits</span>. You can purchase more credits to create more projects.</p>
      </div>
      <Footer />
    </>
  )
