import { CircleIcon, icons, ScanLineIcon, SquareIcon, TriangleIcon } from "lucide-react"
import { useEffect, useState } from "react"


const steps = [
    { icon: ScanLineIcon, lable: "Analyzing your request..." },
    { icon: SquareIcon, lable: "Generating layout structure..." },
    { icon: TriangleIcon, lable: "Assembling UI components..." },
    { icon: CircleIcon, lable: "Finalizing your website..." },
]
...
const LoaderSteps = () => {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
            ...
            <p key={current} className="mt-8 text-lg font-light text-white/90 tracking-wide transition-all duration-700 ease-in-out opacity-100">{steps[current].lable}</p>
